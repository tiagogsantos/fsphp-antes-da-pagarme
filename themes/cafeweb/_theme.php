...
<div class="ajax_load">
    <div class="ajax_load_box">
        ...
        <p class="ajax_load_box_title">Por favor, aguarde...</p>
    </div>
</div>
...
<footer class="main_footer">
    <div class="container content">
        <section class="main_footer_content">
            ...
            <article class="main_footer_content_item">
                <h2>Contato:</h2>
                <p class="icon-phone"><b>Telefone:</b><br> +55 (11) 98368-3004</p>
                <p class="icon-envelope"><b>Email:</b><br> tiagogoncalves044@gmail.com</p>
                <p class="icon-map-marker"><b>Endereço:</b><br> Rua Eduardo de Capua Nº 07, SP/Brasil</p>
            </article>
