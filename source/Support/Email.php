...
class Email
{
    ...
    {
        if (empty($this->data)) {
            $this->body->error("Erro ao enviar, favor verifique os dados");
            return false;
        }

        if (!is_email($this->data->recipient_email)) {
            $this->body->warning("O e-mail de destinatário não é válido");
            return false;
        }

        if (!is_email($from)) {
            $this->body->warning("O e-mail de remetente não é válido");
            return false;
        }
        ...
        try {
            ...
            $this->body->error($exception->getbody());
            return false;
        }
    }
     ...
     * @return bool
     * Agendamento de disparo de e-mail
     */
